...
public class Genotype
{
    ...
    public Genotype(Genotype Mother, Genotype Father)
    {
        ...
        /*вот тут нет смысла проверять корректность, поэтому надо делать это извне после выбора родителей
        чувствую какую-то идейную неправильность, что все генерируются уже ок, а эти могут быть не ок
        надо будет над этим подумать
        либо гененировать всех с возможностью не ок, либо..?
        */
        Square = CalcSquare();
    }
